...
class RevertOrderUseCaseTest {
    ...
    @Test
    void should_publish_status_changed_event_after_reverting() {
        ...
        assertThat(captor.getValue().newStatus()).isEqualTo(OrderStatus.PENDING);
    }
